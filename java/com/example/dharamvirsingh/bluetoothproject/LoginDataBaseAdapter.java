...
public class LoginDataBaseAdapter {
    static final String DATABASE_NAME = "logindata";
    static final int DATABASE_VERSION = 1;
    public static final int NAME_COLUMN = 1;
    // TODO: Create public field for each column in your table.
    // SQL Statement to create a new database.
    static final String DATABASE_CREATE = "create table if not exists "+DATABASE_NAME+"(ID integer primary key,USERNAME  text,PASSWORD text)";
    ...
    public int deleteEntry(String UserName)
    {
        ...
        int numberOFEntriesDeleted= db.delete("LOGINDATA", where, new String[]{UserName}) ;
